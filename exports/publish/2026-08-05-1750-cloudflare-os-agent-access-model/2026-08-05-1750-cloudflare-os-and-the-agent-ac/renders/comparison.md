# Cloudflare OS and the Agent Access Model: implications for AI browser agents, browser automation, anti-detection, and secure agent infrastructure — Comparison

Source: research session `2026-08-05-1750-cloudflare-os-and-the-agent-ac` (adjudicated).
