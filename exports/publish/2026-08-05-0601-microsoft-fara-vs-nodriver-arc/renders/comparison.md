# Microsoft Fara vs Nodriver: architecture, capabilities, and future of AI browser automation — Comparison

Source: research session `2026-08-05-0601-microsoft-fara-vs-nodriver-arc` (adjudicated).
